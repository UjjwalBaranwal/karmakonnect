...
import { LayoutDashboard, Search, Calendar, HeartHandshake, Bell, ShoppingBag, LogOut, PanelLeftClose, PanelLeftOpen, Coins } from 'lucide-react'
...
export default function UserSidebar({ activePage = "" }) {
  ...
  const links = [
    { label: "Dashboard", href: "/user/dashboard", icon: <LayoutDashboard className="h-5 w-5" /> },
