...
export default function NgoSidebar() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-neutral-900">
      {/* Sidebar */}
      <aside
        className={`flex flex-col border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-neutral-800 transition-all duration-300 ${open ? "w-64" : "w-16"}`}
      >
        {/* Logo and toggle */}
        ...
        <div className="flex items-center space-x-3 p-4 border-t border-gray-200 dark:border-gray-700">
          <img
            ...
            alt="NGO avatar"
          />
          {open && <span className="text-sm font-medium text-gray-700 dark:text-white">NGO Admin</span>}
        </div>
      </aside>
