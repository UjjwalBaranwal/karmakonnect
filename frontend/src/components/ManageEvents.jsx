        ...
        <div className="relative w-24 h-24">
          <svg viewBox="0 0 36 36" className="w-full h-full">
            {data.map((item, index) => {
              ...
              const x1 =
                18 + 16 * Math.cos(((startAngle - 90) * Math.PI) / 180);
              const y1 =
                18 + 16 * Math.sin(((startAngle - 90) * Math.PI) / 180);
  ...
  const [events, setEvents] = useState([
    {
      ...
      description:
        "Join us for a day of tree planting and environmental awareness.",
      status: "ongoing",
      volunteers: 45,
      fundsRaised: 25000,
      targetFunds: 50000,
    ...
    },
    {
      ...
      description:
        "Donate clothes for those in need. Help us spread warmth and hope.",
      status: "ended",
      endDate: "2025-05-03",
      volunteers: 32,
      fundsRaised: 15000,
                ...
                <div className="bg-neutral-700/30 p-4 rounded-lg border border-gray-700">
                  ...
                  <div className="mb-4 bg-neutral-700/50 p-3 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="text-sm text-gray-400">
                        {Math.round(
                          (selectedEvent.fundsRaised /
                            selectedEvent.targetFunds) *
                            100
                        )}
                        %
                      </div>
                    ...
                    <div className="text-xs text-right mt-1 text-gray-400">
                      ₹{selectedEvent.fundsRaised.toLocaleString()} of ₹
                      {selectedEvent.targetFunds.toLocaleString()}
                    </div>
                  </div>
